...
import com.bosssoft.bigdata.common.security.exception.*;
 ...
 */
@Slf4j
public class BosxWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
	...
	private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
		...
		return new ResponseEntity<>(new BosxAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,
				HttpStatus.valueOf(status));
