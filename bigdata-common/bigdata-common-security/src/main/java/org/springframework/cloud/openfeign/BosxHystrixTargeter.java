...
class BosxHystrixTargeter implements Targeter {
	...
	public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
		...
		BosxFallbackFactory bosxFallbackFactory = new BosxFallbackFactory(target);
		return (T) builder.target(target, bosxFallbackFactory);
	}
